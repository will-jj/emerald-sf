...
const u8 gText_BattleSwapSingleResults[] = _("{PLAYER}'s Smart Factory Single Results");
const u8 gText_BattleSwapDoubleResults[] = _("{PLAYER}'s Smart Factory Double Results");
