...
extern const u8 gText_SFVersion[];
extern const u8 gText_SFVersionPrefix[];
extern const u8 gText_SFVersionSuffix[];
extern const u8 gText_SFVersionSpacer[];
...
static void Task_DisplayMainMenu(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        // Setup version text
        StringCopy(gStringVar1, gText_SFVersionPrefix);
        StringAppend(gStringVar1, gText_Space2);
        StringAppend(gStringVar1, gText_SFVersion);
        StringAppend(gStringVar1, gText_SFVersionSpacer);
        StringAppend(gStringVar1, gText_SFVersionSuffix);      
